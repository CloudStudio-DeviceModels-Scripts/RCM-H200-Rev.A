...
# Configuration Script – RCM®-H200 - Rev. A

This **Configuration** script is designed for the **RCM®-H200** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – RCM®-H200 Rev. A

Este script de **Configuration** está diseñado para el modelo **RCM®-H200** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
